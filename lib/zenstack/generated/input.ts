...
export type TodoListGetPayload<Args extends $SelectIncludeOmit<$Schema, "TodoList", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "TodoList", Options, Args>;
