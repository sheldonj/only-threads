...
type AdminSaleNotificationEmailProps = {
...
export const AdminSaleNotificationEmail = ({
  ...
  purchaseDate,
  stripePaymentId,
}: AdminSaleNotificationEmailProps) => {
  const previewText = `New sale: ${courseTitle} purchased by ${customerName}`;
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              A new course purchase has been made on your platform.
            </Text>
            <Section className="bg-[#f0fdf4] border border-solid border-[#86efac] rounded p-[16px] my-[24px]">
...
export function reactAdminSaleNotificationEmail(
  props: AdminSaleNotificationEmailProps,
) {
